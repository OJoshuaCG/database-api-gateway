# API Reference v18 — Eliminar una versión intermedia de un blueprint
...
"aplicada hoy", y convive con [`api-reference-v15.md`](api-reference-v15.md), que abrió la vía
para editar una versión vigente: **ese freeze no cambia acá**, solo el del borrado. Acá
cambia **qué versiones se pueden borrar** y aparece un endpoint nuevo.
