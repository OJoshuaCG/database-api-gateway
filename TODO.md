...
| --- | --- | --- | --- | --- |
| T-260824-lz-collation-lote-y-version | [86e2ywnrg](https://app.clickup.com/t/86e2ywnrg) | LeoZubiri@outlook.com | 2026-08-24 | `collation_conversion_controller.py`, `migrations.py::execute_adhoc`, `managed_migration_controller.py::_destructive_versions`, `models/collation_conversion_job.py` + tabla de lote nueva, `routes/v1/{collation_conversions,database_models}.py`, migración Alembic `a6b7c8d9e0f1` |
